...
const offline_theme_themes = [
	[
		...
		'9px 7px 40px -6px rgba(0,0,0,.25)','#eee','#000','transparent','#3498DB','#fff','#2E86C1','#208f4e','#fff','#229954','#1E8449','#fff','#196F3D','#ff7b00','#fff','#E67E22','#D68910','#fff','#CA6F1E','#C0392B','#fff','#A93226','#A93226','#fff','#C0392B'
	],
	[
