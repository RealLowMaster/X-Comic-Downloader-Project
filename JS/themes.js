...
const offline_theme_themes = [
	[
		...
		'9px 7px 40px -6px rgba(0,0,0,.25)','#eee','#000','transparent','#3498DB','#fff','#2E86C1','#208f4e','#fff','#229954','#1E8449','#fff','#196F3D','#ff7b00','#fff','#E67E22','#D68910','#fff','#CA6F1E','#C0392B','#fff','#A93226','#A93226','#fff','#C0392B','#fff','0 0 5px 0 #0009','#fff','#212529','#ced4da','#3498DB','#b700ff','rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px','rgba(0, 0, 0, 0.2) 0px 18px 50px -10px'
	],
	[
		...
		'9px 7px 40px -6px rgba(0,0,0,.25)','#eee','#000','transparent','#3498DB','#fff','#2E86C1','#208f4e','#fff','#229954','#1E8449','#fff','#196F3D','#ff7b00','#fff','#E67E22','#D68910','#fff','#CA6F1E','#C0392B','#fff','#A93226','#A93226','#fff','#C0392B','#333','0 0 5px 0 #0009','#111','#fff','#000','#3498DB','#b700ff',
		'rgba(0,50,150,.4) 0px 4px 6px -1px, rgba(0,0,150,.06) 0px 2px 4px -1px',
		'rgba(150,0,150,.6) 0px 18px 50px -10px'
	]
]
