...
const ThisWindow = remote.getCurrentWindow(), loading = new Loading(10), Downloader = new DownloadManager(), PageManager = new OfflinePageManager(), db = {}, procressPanel = new ProcressPanel(0), update_number = 13
